...
module.exports = {
    ...
    resolve: {
        alias: {
            ...
            "simplebar": path.resolve('node_modules', 'simplebar/dist/simplebar.js'),
            "device": path.resolve('node_modules', 'current-device/umd/current-device.js'),
            "tilt": path.resolve('node_modules', 'tilt.js/src/tilt.jquery.js'),
            "jquery-ui": path.resolve('node_modules', 'jquery-ui/jquery-ui.js'),
        }
    }
};